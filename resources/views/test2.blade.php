...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Nice Select CSS -->
		<link rel="stylesheet" href="{{asset('assets/css/nice-select') }}">
		<!-- Font Awesome CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/font-awesome.min') }}">
		<!-- icofont CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/icofont') }}">
		<!-- Slicknav -->
		<link rel="stylesheet" href="{{asset('assets/css/slicknav.min') }}">
		<!-- Owl Carousel CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/owl-carousel') }}">
		<!-- Datepicker CSS -->
		<link rel="stylesheet" href="{{asset('assets/css/datepicker') }}">
		<!-- Animate CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/animate.min') }}">
		<!-- Magnific Popup CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/magnific-popup') }}">
		
		<!-- Medipro CSS -->
        <link rel="stylesheet" href="{{asset('assets/css/normalize') }}">
        <link rel="stylesheet" href="{{asset('assets/css/style.css')}}">
        <link rel="stylesheet" href="{{asset('assets/css/responsive') }}">
